...
class Paradigm:
	...
	"""
	def __init__(self, wrd: dict) -> None:
		"""
	...
	def find_prefix(lem: str, inf: str) -> (boolean, str):
		"""
...
class Features:
	...
	"""
	def __init__(self, wrd: str, prefix: str, yer:boolean, lemma=False) -> None:
		"""
